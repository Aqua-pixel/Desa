...
Route::middleware(['auth'])->prefix('admin')->group(function () {
    ...
    // Route CRUD untuk Aparatur
    Route::get('aparatur/', [AparaturController::class, 'index'])->name('admin.aparatur.index');  // Menampilkan daftar aparatur
    Route::get('aparatur/create', [AparaturController::class, 'create'])->name('admin.aparatur.create'); // Menampilkan form create
    Route::post('aparatur/', [AparaturController::class, 'store'])->name('admin.aparatur.store');  // Proses penyimpanan data baru
    Route::get('aparatur/{aparatur}/edit', [AparaturController::class, 'edit'])->name('admin.aparatur.edit'); // Menampilkan form edit
    Route::put('aparatur/{aparatur}', [AparaturController::class, 'update'])->name('admin.aparatur.update'); // Proses update data
    Route::delete('aparatur/{aparatur}', [AparaturController::class, 'destroy'])->name('admin.aparatur.destroy'); // Proses hapus data
